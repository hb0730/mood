...
// 根据variant自动设置显示内容
const computedShowUserCount = computed(() => 
  props.variant === 'default' ? props.showUserCount : false
)

const computedShowAdminBadge = computed(() => 
  props.variant === 'admin' ? true : false
)
</script>

...
const extractTranslationKeys = () => {
  try {
    ...
    const knownKeys = [
      ...
      'report.processing', 'report.reportComment', 'report.cancelReportComment', 'report.addCommentFailed',
      'report.reportContent', 'report.reportPurpose', 'report.cancelReport', 'report.clickToCancel',
      ...
      'modals.createPost.tagLimit', 'modals.createPost.anonymous', 'modals.createPost.displayName',
      ...
      'modals.comments.title', 'modals.comments.discussion', 'modals.comments.anonymousUser',
      'modals.comments.commentReported', 'modals.comments.underReview', 'modals.comments.addComment',
